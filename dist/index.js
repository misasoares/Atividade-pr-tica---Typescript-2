...
const contador = new _1_1.default();
...
const bola = new _2_1.default("verde", 6, "plastico");
console.log(bola);
bola.trocarCor("rosa");
...
const conta = new _3_1.default("misael");
console.log(conta);
...
const calculadora = new _4_1.default();
...
const bombaCombustivel = new _5_1.default();
